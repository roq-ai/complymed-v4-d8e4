...
import { getComplianceReportById } from 'apiSdk/compliance-reports';
import { ComplianceReportInterface } from 'interfaces/compliance-report';

function ComplianceReportViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Compliance Report Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('compliance_report', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/compliance-reports/edit/${id}`} passHref legacyBehavior>
                    <Button
