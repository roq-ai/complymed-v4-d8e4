...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'compliance_report.count', 'dashboard.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('compliance_report', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'compliance_report',
          header: 'Compliance Report',
          accessorKey: 'compliance_report',
          cell: ({ row: { original: record } }: any) => record?._count?.compliance_report,
        }
      : null,
    hasAccess('dashboard', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'dashboard',
          header: 'Dashboard',
          accessorKey: 'dashboard',
          cell: ({ row: { original: record } }: any) => record?._count?.dashboard,
        }
      : null,
