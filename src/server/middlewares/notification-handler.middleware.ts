...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create': {
    roles: ['organisation-admin', 'business-admin'],
    key: 'new-task-assigned',
    tenantPath: ['organization', 'dashboard', 'task'],
    userPath: [],
  },
  'compliance_report.create': {
    roles: ['business-admin'],
    key: 'compliance-report-added',
    tenantPath: ['organization', 'compliance_report'],
    userPath: [],
  },
  'message.create': {
    roles: ['super-admin', 'organisation-admin', 'business-admin'],
    key: 'message-received',
    tenantPath: ['organization', 'user', 'message'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['super-admin', 'organisation-admin'];
